...
```bash
docker run --rm -it -p 8554:8554 -p 1935:1935 -p 8889:8889 -p 8189:8189/udp -p 8000:8000/udp -p 8001:8001/udp bluenviron/mediamtx:latest-ffmpeg
...
**Note:** **OM_API_KEY_ID** is extracted from your full API key. 

**Example:**
- Full API key: `om_prod_1234567890abcdef_remaining_characters`
- OM_API_KEY_ID: `1234567890abcdef` (first 16 characters after `om_prod_`)

You can also find your **OM_API_KEY_ID** directly in the [portal](https://portal.openmind.org).
